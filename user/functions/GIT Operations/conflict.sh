...
handle_git_conflict() {
    ...
    echo "ALERT:Git Conflict|Your version of the project came out of sync with the server. To protect everyone's work and time, we will close Final Cut, make a backup of your current version, then download the most recent version of the project from the server."
